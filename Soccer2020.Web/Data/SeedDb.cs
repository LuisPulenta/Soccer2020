...
namespace Soccer2020.Web.Data
{
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckUserAsync("22222222", "Pablo", "Lacuadri", "lacuadri@yopmail.com", "156 202 020", "Villa Santa Ana", UserType.User);
            await CheckUserAsync("33333333", "Diego", "Maradona", "maradona@yopmail.com", "156 303 030", "Villa Fiorito", UserType.User);
            await CheckUserAsync("44444444", "Lionel", "Messi", "messi@yopmail.com", "156 404 040", "Barcelona", UserType.User);
